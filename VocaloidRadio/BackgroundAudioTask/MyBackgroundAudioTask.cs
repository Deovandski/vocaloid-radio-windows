 ...
 */
using BackgroundAudio.MyPlaylistManager;
using System;
...
namespace BackgroundAudioTask
{
    ...
    public sealed class MyBackgroundAudioTask : IBackgroundTask
    {
        ...
        private string currentTitle = "Vocaloid Radio";
        ...
        private void UpdateUVCOnNewTrack()
        {
            ...
            systemmediatransportcontrol.DisplayUpdater.MusicProperties.Title = currentTitle;
        ...
        private void StartPlayback()
        {
            try
            {
                    ...
                    Debug.WriteLine("Start Playback! || TrackName: " + Playlist.CurrentTrackName.ToString());
                    Playlist.StartSelectedStream((string)currenttrackname);
                    if (Playlist.CurrentTrackName == "128")
                    {
                        currentTitle = "Vocaloid Radio 128 kbps";
                    }
                    else
                    {
                        currentTitle = "Vocaloid Radio 192 kbps";
                    }
                    UpdateUVCOnNewTrack();

...
namespace Vocaloid_Radio
{
    ...
    public partial class RadioStream_192 : PhoneApplicationPage
    {
        public RadioStream_192()
        {
            InitializeComponent();
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                networkStatus.Text = "Fatal Error... Please restart the App.";
        ...
        private void playRadio()
        {
              if (System.Net.NetworkInformation.NetworkInterface.GetIsNetworkAvailable() == true)
            {
                ...
                try
                {
                    ...
                    AudioTrack radioStream_128 = new AudioTrack(new Uri("http://curiosity.shoutca.st:8019/stream", UriKind.Absolute),
                    "VocaloidRadio.com 192kbps", "Online 24/7 Radio", "", null);
                    streamStatus.Text = "Please Wait for Radio Setup. 45% Complete";
                    BackgroundAudioPlayer.Instance.Track = radioStream_128;
                    streamStatus.Text = "Please Wait for Radio Setup. 65% Complete";

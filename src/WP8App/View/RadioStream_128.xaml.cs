...
{
    public partial class RadioStream_128 : PhoneApplicationPage
    {
        public RadioStream_128()
        {
            InitializeComponent();
        ...
        private void playRadio()
        {
              if (System.Net.NetworkInformation.NetworkInterface.GetIsNetworkAvailable() == true)
            {
                ...
                try
                {
                    ...
                    AudioTrack radioStream_128 = new AudioTrack(new Uri("http://curiosity.shoutca.st:8019/128", UriKind.Absolute),
                    "VocaloidRadio.com 128kbps", "Online 24/7 Radio", "", null);

...
{
    public partial class RadioStreamerSelection : PhoneApplicationPage
    {
        public RadioStreamerSelection()
        {
            InitializeComponent();
        ...
        {
            InitializeAppBarpanoramaMenuSection_Menu(PanoramaMenuSection_RadioSelection.SelectedItem as PanoramaItem);
        }
